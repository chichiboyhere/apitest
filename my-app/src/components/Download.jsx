...
// }
  return (
    <div className={`${styles.section} ${styles.bgWhite}`}>
      ...
      <a href="/mentalgame/staticfiles/images/interact_with_math.pdf" download><button className={styles.btnPrimary}  disabled={!isNotClicked}><FontAwesomeIcon icon ={faDownload}></FontAwesomeIcon> Download</button></a>
