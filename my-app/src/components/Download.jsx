...
// }
  return (
    <div className={`${styles.section} ${styles.bgWhite}`}>
      ...
      <a href={assets.bria} download><button className={styles.btnPrimary}  disabled={!isNotClicked}><FontAwesomeIcon icon ={faDownload}></FontAwesomeIcon> Download</button></a>
